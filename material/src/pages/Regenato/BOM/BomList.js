                                            ...
                                            <table className="table align-middle table-nowrap" id="customerTable">
                                                <thead className="table-light">
                                                    <tr>
                                                        ...
                                                        <th className="sort" data-sort="customer_name">Po Name</th>
                                                        <th className="sort" data-sort="total-price">Total Price</th>
                                                        <th className="sort" data-sort="total-cost">Total Cost</th>
                                                        <th className="sort" data-sort="date-created">Date Created</th>
