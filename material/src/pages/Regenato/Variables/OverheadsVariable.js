...
const OverheadsVariable = () => {
  ...
  //         try {
  //             const response = await fetch('${process.env.REACT_APP_BASE_URL}/api/overheadsAndProfit');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BASE_URL}/api/overheadsAndProfit/${editId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDelete = async (_id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BASE_URL}/api/overheadsAndProfit/${_id}`,
        {
          method: "DELETE",
        }
      );
