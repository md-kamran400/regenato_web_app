    ...
    <Modal isOpen={isOpen} toggle={toggle} size="lg">
      ...
      <ModalBody>
        {loading ? (
          ...
          <div className="text-center">No downtime records found for this machine.</div>
        ) : (
          <Table bordered responsive>
            ...
            <tbody>
              {downtimeHistory.map((downtime, index) => (
                <tr key={index}>
                  <td>{format(new Date(downtime.startTime), 'dd/MM/yyyy HH:mm')}</td>
                  <td>
                    {downtime.endTime 
                  ...
                  <td>
                    {!downtime.endTime && new Date(downtime.startTime) <= new Date() && (
                      <Button 
                        color="success" 
                        size="sm"
