    ...
    <React.Fragment>
      ...
      <Modal isOpen={modal_add} toggle={tog_add} centered>
        <ModalHeader className="bg-light p-3" toggle={tog_add}>
          {formData.id ? "Edit Manufacturing Static Variables" : "Add Manufacturing Static Variables"}
        </ModalHeader>
        <ModalBody>
      ...
      <Modal isOpen={modal_edit} toggle={tog_edit}>
        <ModalHeader toggle={tog_edit}>Edit Manufacturing Static Variables</ModalHeader>
        <ModalBody>
