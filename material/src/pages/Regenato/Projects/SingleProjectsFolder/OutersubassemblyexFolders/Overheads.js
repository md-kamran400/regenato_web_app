...
const Overheads = ({
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const endpoint = `${process.env.REACT_APP_BASE_URL}/api/defpartproject/projects/${projectId}/subAssemblyListFirst/${subAssemblyId}/items/${partId}/overheadsAndProfits/${editId}`;
