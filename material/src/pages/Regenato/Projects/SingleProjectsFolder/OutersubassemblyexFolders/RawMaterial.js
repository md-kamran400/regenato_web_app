...
const RawMaterial = ({
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const endpoint = `${process.env.REACT_APP_BASE_URL}/api/defpartproject/projects/${projectId}/subAssemblyListFirst/${subAssemblyId}/items/${partId}/rmVariables/${editId}`;
      ...
      rawMatarialsUpdate(updatedData);
