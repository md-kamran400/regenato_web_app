...
const Shipment = ({
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const endpoint = `${process.env.REACT_APP_BASE_URL}/api/defpartproject/projects/${projectId}/subAssemblyListFirst/${subAssemblyId}/items/${partId}/shipmentVariables/${editId}`;
