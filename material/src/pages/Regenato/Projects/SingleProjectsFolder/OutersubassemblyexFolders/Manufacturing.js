...
const Manufacturing = ({
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const endpoint = `${process.env.REACT_APP_BASE_URL}/api/defpartproject/projects/${projectId}/subAssemblyListFirst/${subAssemblyId}/items/${partId}/manufacturingVariables/${editId}`;
      // const endpoint = `${process.env.REACT_APP_BASE_URL}/api/subAssembly/${assemblyId}/subAssemblies/${subAssemblyId}/parts/${partId}/manufacturingVariables/${editId}`;
      ...
      manufatcuringUpdate(updatedData);
