...
const HoursPlanningTab = () => {
    ...
    const getHoursForPartListItems = (column,quantity,manufacturingVariables) => {
                                                        ...
                                                        <tbody>
                                                            <tr className="table-row-main">
                                                                ...
                                                                {["VMC Imported", "VMC Local", "Milling Manual", "Grinding Final", "CNC Lathe", "Drill/Tap", "Wire Cut Local", "Wire Cut Rough", "Wire Cut Imported", "EDM", "Black Oxide", "Laser Marking", "Lapping/Polishing", "Grinding Blank/Rough", "Gauges & Fixtures"].map((processName) => (
                                                                    <td key={processName}>
                                                                        {calculateTotalHoursForPartsList(processName, partsList)}
                                                                    </td>
                                                                ))}
                                                            </tr>
                                                            <tr className="table-row-main">
                                                                ...
                                                                {["VMC Imported", "VMC Local", "Milling Manual", "Grinding Final", "CNC Lathe", "Drill/Tap", "Wire Cut Local", "Wire Cut Rough", "Wire Cut Imported", "EDM", "Black Oxide", "Laser Marking", "Lapping/Polishing", "Grinding Blank/Rough", "Gauges & Fixtures"].map((processName) => (
                                                                    <td key={processName}>
                                                                        <input
                                                                            ...
                                                                            type="number"
                                                                            value={machineHoursPerDay[`${processName}_${partsList._id}`] || 0}
                                                                            onChange={(e) => handleInputChange(e, "machineHoursPerDay", `${processName}_${partsList._id}`)}
                                                                        />
                                                                    </td>
                                                                ))}
                                                            </tr>
                                                                ...
                                                                {["VMC Imported", "VMC Local", "Milling Manual", "Grinding Final", "CNC Lathe", "Drill/Tap", "Wire Cut Local", "Wire Cut Rough", "Wire Cut Imported", "EDM", "Black Oxide", "Laser Marking", "Lapping/Polishing", "Grinding Blank/Rough", "Gauges & Fixtures"].map((processName) => (
                                                                    <td key={processName}>
                                                                        <input
                                                                            className="input-field"
                                                                            type="number"
                                                                            value={numberOfMachines[`${processName}_${partsList._id}`] || 0}
                                                                            onChange={(e) => handleInputChange(e, "numberOfMachines", `${processName}_${partsList._id}`)}
                                                                        />
                                                                    </td>
                                                                ))}
                                                            </tr>
                                                                ...
                                                                {["VMC Imported", "VMC Local", "Milling Manual", "Grinding Final", "CNC Lathe", "Drill/Tap", "Wire Cut Local", "Wire Cut Rough", "Wire Cut Imported", "EDM", "Black Oxide", "Laser Marking", "Lapping/Polishing", "Grinding Blank/Rough", "Gauges & Fixtures"].map((processName) => (
                                                                    <td key={processName}>
                                                                        <input
                                                                            className="input-field"
                                                                            type="number"
                                                                            value={daysToWork[`${processName}_${partsList._id}`] || 0}
                                                                            onChange={(e) => handleInputChange(e, "daysToWork", `${processName}_${partsList._id}`)}
                                                                        />
                                                                    </td>
                                                                ))}
                                                            </tr>
                                                            ...
                                                            <tr className="table-row-main">
                                                                ...
                                                                {["VMC Imported", "VMC Local", "Milling Manual", "Grinding Final", "CNC Lathe", "Drill/Tap", "Wire Cut Local", "Wire Cut Rough", "Wire Cut Imported", "EDM", "Black Oxide", "Laser Marking", "Lapping/Polishing", "Grinding Blank/Rough", "Gauges & Fixtures"].map((processName) => (
                                                                    <td key={processName}>
                                                                        {calculateMonthsRequiredForPartsList(processName, partsList)}
                                                                    </td>
                                                                ))}
                                                            </tr>
                                                        </tbody>
