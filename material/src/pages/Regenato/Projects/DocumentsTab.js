      ...
      <Row lg={12}>
        ...
        <table className="table align-middle table-nowrap">
          ...
          <tbody>
              <tr>
                <td>VMC Local</td>
                <td><Button className="bg-info" onClick={tog_add_machine}>Assign</Button></td>
                {/*<td>
                 <select className="form-select" aria-label=".form-select-sm example">
                    <option >Select</option>
                    <option defaultValue="1">VMC 01</option>
                    <option defaultValue="2">VMC 02</option>
                    <option defaultValue="3">VMC 03</option>
                    <option defaultValue="4">VMC 04</option>
                    <option defaultValue="5">VMC 05</option> 
                </select>
                </td>*/}
              </tr>
              <tr>
              ...
              <td><Button className="bg-info" onClick={tog_add_machine}>Assign</Button></td>
                ...
                <select className="form-select" aria-label=".form-select-sm example">
                    <option >Select</option>
                    <option defaultValue="1">Milling 01</option>
                    <option defaultValue="2">Milling 02</option>
                    <option defaultValue="3">Milling 03</option>
                    <option defaultValue="4">Milling 04</option>
                    <option defaultValue="5">Milling 05</option>
                </select> 
                </td>*/}
              </tr>
              <tr>
