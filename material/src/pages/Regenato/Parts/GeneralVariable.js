...
const GeneralVariable = ({partDetails}) => {
    ...
    const tog_add = () => {
        ...
        if (generlvariabledata.length > 0) {
            const lastId = generlvariabledata[generlvariabledata.length - 1].id;
    ...
    const handleSubmit = async (e) => {
      ...
      const handleDelete = async (_id) => {
        ...
        setError(null);
        try {
            const response = await fetch(`http://localhost:4040/api/parts/${partDetails._id}/generalVariables/${_id}`, {
                method: 'DELETE',
            });
            if (!response.ok) {
                throw new Error('Network response was not ok');
    ...
    return (
        <React.Fragment>
            ...
            <Modal isOpen={modal_add} toggle={tog_add} centered>
                <ModalHeader className="bg-light p-3" toggle={tog_add}> Add Customer </ModalHeader>
                <ModalBody>
                <form className="tablelist-form" onSubmit={handleSubmit}>
                    <ModalBody>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" id="id-field" className="form-control" placeholder="Enter Category ID" name='id' value={formData.id} onChange={handleChange}  required />
                        </div>
                        <div className="mb-3">
              ...
              />
                 ...
                 <div className="mb-3">
                    ...
                    <ModalFooter>
                        <Button color="danger" className="add-btn me-1" onClick={() => setModalList(false)}>
                            Cancel
                        </Button>
