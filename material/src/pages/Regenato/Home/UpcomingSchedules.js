            ...
            <div className="col-xxl-4">
                <div className="card">
                    ...
                    <div className="card-body pt-0">
                        ...
                        <h6 className="text-uppercase fw-semibold mt-4 mb-3 text-muted">Timeline::</h6>
                        <div className="mini-stats-wid d-flex align-items-center mt-3">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1">Project 1</h6>
                                <p className="text-muted mb-0">VMC Local </p>
                            </div>
                        ...
                        <div className="mini-stats-wid d-flex align-items-center mt-3">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1">Project 2</h6>
                                <p className="text-muted mb-0">Grinding Final</p>
                            </div>
                            <div className="flex-shrink-0">
                        ...
                        <div className="mini-stats-wid d-flex align-items-center mt-3">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1">Project 3 </h6>
                                <p className="text-muted mb-0">Wire Cut Local</p>
                            </div>
                            <div className="flex-shrink-0">
                        ...
                        <div className="mini-stats-wid d-flex align-items-center mt-3">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1">Project 4</h6>
                                <p className="text-muted mb-0">Wire Cut Imported</p>
                            </div>
                            <div className="flex-shrink-0">
