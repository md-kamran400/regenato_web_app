      ...
      try {
        ...
        const processedData = manufacturingRes
          .map((category) => {
            ...
            console.log(
              `Category ${category.name}: Total=${total}, Occupied=${occupied}, Available=${available}`
            );
  ...
  return (
    ...
    >
      ...
      <ResponsiveContainer width="100%" height="80%">
        ...
        >
          ...
          <Tooltip
            formatter={(value, name) => [
              value,
              name === "available" ? "Available Machines" : "Occupied Machines",
            ]}
        ...
        <Legend
            formatter={(value) =>
              value === "available" ? "Available Machines" : "Occupied Machines"
            }
          />
      </ResponsiveContainer>
    </div>
