...
const Navdata = () => {
  ...
  const [isRegenato, setIsRegenato] = useState(false);
  ...
  const [iscurrentState, setIscurrentState] = useState("Regenato");
  ...
  const menuItems = [
    ...
    //start here regenato  
    {
      ...
      link: "/#",
      stateVariables: isRegenato,
      click: function (e) {
        e.preventDefault();
        setIsRegenato(!isRegenato);
        setIscurrentState("Regenato");
        updateIconSidebar(e);
      },
      subItems: [
        {
